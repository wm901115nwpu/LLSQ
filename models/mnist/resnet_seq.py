...
__all__ = ['ResNet', 'mnist_resnet18', 'seq_resnet34', 'seq_resnet50', 'seq_resnet101',
           'seq_resnet152']

model_urls = {
    'resnet18': 'https://fake/models/mnist-resnet18-xxx-xxx.pth',
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False):
        ...
        self.inplanes = 64
        self.conv1_seq = nn.Sequential(nn.Conv2d(1, 64, kernel_size=3, stride=1, padding=1,
                                                 bias=False),
                                       nn.BatchNorm2d(64),
                                       )
        self.relu = nn.ReLU(inplace=True)
