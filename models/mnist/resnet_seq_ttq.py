...
__all__ = ['ResNet', 'mnist_resnet18_ttq', 'mnist_resnet18_tbq', 'mnist_resnet18_bwn',
           'seq_resnet34',
...
def mnist_resnet18_ttq(pretrained=False, **kwargs):
...
def mnist_resnet18_bwn(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        We have changed the original ResNet18 architecture according to [1] for better performance.
...
def mnist_resnet18_tbq(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        We have changed the original ResNet18 architecture according to [1] for better performance.
