...
__all__ = ['ResNet', 'svhn_resnet18_ttq', 'svhn_resnet18_tbq', 'svhn_resnet18_bwn',
           'seq_resnet34',
           'seq_resnet50', 'seq_resnet101',
           'seq_resnet152']

model_urls = {
    'resnet18': 'https://fake/models/svhn-resnet18-96.4.pth',
...
def svhn_resnet18_ttq(pretrained=False, **kwargs):
...
def svhn_resnet18_bwn(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        We have changed the original ResNet18 architecture according to [1] for better performance.
...
def svhn_resnet18_tbq(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        We have changed the original ResNet18 architecture according to [1] for better performance.
